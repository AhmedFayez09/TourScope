...
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen({Key? key, required this.roomId}) : super(key: key);
  @override
  State<StatefulWidget> createState() => MySampleState();
}

class MySampleState extends State<PaymentScreen> {
  String cardNumber = '';
  String expiryDate = '';
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          //   image: ExactAssetImage('assets/images/master.png'),
          //   fit: BoxFit.contain,
          // ),
          color: Colors.black,
        ),
  ...
  void BayNow() {
    if (formKey.currentState!.validate()) {
      SnackBar snackBar = SnackBar(content: Text("congratulations To Pay"));
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
      Provider.of<GeneralProvider>(context, listen: false)
          .addReservationList(roomId: widget.roomId);
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (_) => HotelHomeScreen()));
    } else {
      print('invalid!');
    }
  }
