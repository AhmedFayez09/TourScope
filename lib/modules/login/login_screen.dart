                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        CommonTextFieldView(
                          ...
                          titleText:
                              AppLocalizations(context).of("your_mail"),
                        ...
                        _forgotYourPasswordUI(),
                             ...
                             CommonButton(
                                ...
                                onTap: () {
                                  log("email ${_emailController.text.toString()} pass => ${ _passwordController.text.toString()}");
                                 
                                  if (_allValidation()) {
                                    context.read<GeneralProvider>().login(
