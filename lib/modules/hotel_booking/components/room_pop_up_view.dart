                  ...
                  child: CommonCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // getRowView(
                        //     "Children", _roomData!.children, PopupTextType.ch),
                        Padding(
...
class RoomPopupView2 extends StatefulWidget {
  final Function(RoomData) onChnage;
  final bool barrierDismissible;
  final RoomData roomData;

  const RoomPopupView2({
    Key? key,
    required this.barrierDismissible,
    required this.onChnage,
    required this.roomData,
  ...
  @override
  _RoomPopupView2State createState() => _RoomPopupView2State();
}

class _RoomPopupView2State extends State<RoomPopupView>
    with TickerProviderStateMixin {
  PopupTextType popupTextType = PopupTextType.no;
  late AnimationController animationController;
